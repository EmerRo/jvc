<?php
// app/models/OtroArchivoPlantilla.php

class OtroArchivoPlantilla
{
    private $id;
    private $titulo;
    private $contenido;
    ...
    {
        $sql = "SELECT * FROM otros_archivos_plantillas ORDER BY id DESC LIMIT 1";
        ...
        if ($fila = $result->fetch_assoc()) {
            ...
            $this->contenido = "<h2 style='text-align: center;'>DOCUMENTO</h2><p><br></p><p>Fecha: [FECHA]</p><p>Asunto: [ASUNTO]</p><p><br></p><p>Contenido del documento...</p><p><br></p><p>Atentamente,</p><p><br></p><p>[NOMBRE]</p><p>[CARGO]</p>";
    ...
    {
        $sql = "INSERT INTO otros_archivos_plantillas (titulo, contenido, header_image, footer_image) 
                VALUES (?, ?, ?, ?)";
    ...
    {
        $sql = "UPDATE otros_archivos_plantillas 
