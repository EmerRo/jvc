<?php
// app/models/ArchivoInternoPlantilla.php

class ArchivoInternoPlantilla
{
    private $id;
    private $titulo;
    private $contenido;
    ...
    {
        $sql = "SELECT * FROM archivos_internos_plantillas ORDER BY id DESC LIMIT 1";
        ...
        if ($fila = $result->fetch_assoc()) {
            ...
            $this->titulo = "DOCUMENTO INTERNO";
            $this->contenido = "<h2 style='text-align: center;'>DOCUMENTO INTERNO</h2><p><br></p><p>Fecha: [FECHA]</p><p>Asunto: [ASUNTO]</p><p><br></p><p>Contenido del documento...</p><p><br></p><p>Atentamente,</p><p><br></p><p>[NOMBRE]</p><p>[CARGO]</p>";
    ...
    {
        $sql = "INSERT INTO archivos_internos_plantillas (titulo, contenido, header_image, footer_image) 
                VALUES (?, ?, ?, ?)";
    ...
    {
        $sql = "UPDATE archivos_internos_plantillas 
