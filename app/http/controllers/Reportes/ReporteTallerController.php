    ...
    <div class='no-space'>
        ...
        if (empty($fotos)) {
            ...
            for ($i = 0; $i < count($fotos); $i += 4) {
                ...
                if ($i < count($fotos)) {
                    $imagePath = ImageStorage::url('cotizaciones-taller', $fotos[$i]);
                    $html .= "
                ...
                if ($i + 1 < count($fotos)) {
                    $imagePath = ImageStorage::url('cotizaciones-taller', $fotos[$i + 1]);
                    $html .= "
                    <td style='width: 50%; padding: 3px; text-align: center;'>
                        <img src='" . $imagePath . "' style='width: 320px; height: 320px; object-fit: contain; border: 1px solid #ddd;'>
                    </td>";
                ...
                // Tercera imagen
                if ($i + 2 < count($fotos)) {
                    $imagePath = ImageStorage::url('cotizaciones-taller', $fotos[$i + 2]);
                    $html .= "
                    <td style='width: 50%; padding: 3px; text-align: center;'>
                        <img src='" . $imagePath . "' style='width: 320px; height: 320px; object-fit: contain; border: 1px solid #ddd;'>
                    </td>";
                ...
                // Cuarta imagen
                if ($i + 3 < count($fotos)) {
                    $imagePath = ImageStorage::url('cotizaciones-taller', $fotos[$i + 3]);
                    $html .= "
                    <td style='width: 50%; padding: 3px; text-align: center;'>
                        <img src='" . $imagePath . "' style='width: 320px; height: 320px; object-fit: contain; border: 1px solid #ddd;'>
                    </td>";
