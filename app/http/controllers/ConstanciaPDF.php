 ...
 public function generarConstanciaPDF($id_constancia)
{
    ...
    $this->mpdf->SetTitle($constancia->getTitulo());
    ...
    // Construir el HTML con la misma estructura que en generarVistaPreviaPDF
    $html = '
    <style>
        @page {
            margin: 0;
    ...
    <div class="content">
        <div class="title">' . $constancia->getTitulo() . '</div>
        <div class="text">' . $constancia->getContenido() . '</div>
    </div>
    ...
    $this->mpdf->Output("Constancia_" . $constancia->getTipo() . ".pdf", "I");
}
