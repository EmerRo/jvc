...
Route::post('/ajs/getAllCuotas/byIdVenta', "CobranzaController@getAllByIdVenta");
...
Route::post('/ajs/cuentas/ventas/render', "PagosController@render");
Route::post('/ajs/getAllCuotas/byIdCompra', "PagosController@getAllByIdCompra");
...
Route::post('/ajs/compra/buscar/producto', "ComprasController@buscarProducto");
Route::post('/ajs/compras/add', "ComprasController@guardarCompras");
Route::post('/ajs/compra/pagos', "ComprasController@getPagos");
...
Route::post('/ajs/taller/cotizacion/guardar-fotos', "TallerCotizacionesController@guardarFotos");
Route::get('/ajs/taller/cotizacion/get-fotos/{id}', "TallerCotizacionesController@getFotos");
Route::post('/ajs/taller/cotizacion/eliminar-foto/{id}/{nombre}', "TallerCotizacionesController@eliminarFoto");
Route::get('/ajs/notificaciones/obtener', "TallerCotizacionesController@obtenerNotificaciones");
