                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div>
                                                                ...
                                                                <button class="btn btn-primary" @click="encender"
                                                                    id="escaner">Escanear</button>
                                                            </div>
                                                            <video id="preview" width="50%"
                                                                style="display: none; margin-bottom: 50px;"></video>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr v-for="product in productoInfo "
                                                                                            ...
                                                                                            <td
                                                                                                style="text-align: center;">
                                                                                                <button
                                                                                                    @click="agregarLista(product.id_producto,product.descripcion,product.cantidad, $event)"
