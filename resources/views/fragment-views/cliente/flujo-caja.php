    ...
    <div class="row align-items-center">
        <div class="col-md-8">
            ...
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active" aria-current="page" style="color: #CA3438;">Caja chica</li>
            </ol>
        </div>
        <div class="col-md-4">
            ...
            <div class="card-body">
                ...
                if (!$isAbierta) {
                    ...
                    <div class="text-center">
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#modal-add-caja"
                            class="btn bg-rojo text-white mt-4">Abrir Caja</button>
                    </div>
                    <div class="modal fade" id="modal-add-caja" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input required @keypress="onlyNumber" v-model="apertura.monto" type="text"
                                                    class="form-control">
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="col-md-12 text-end m-3">
                                <button @click="cerrarCajaChica" class="btn border-gris">Cerrar Caja Chica</button>
                                <a href="<?= URL::to("/reporte/caja/excel/$cajaid") ?>" class="btn border-rojo">Exportar
                                    Caja
                                    Chica</a>
                                <button data-bs-toggle="modal" data-bs-target="#modal-add-caja-chica"
                        ...
                        <div class="modal fade" id="modal-add-caja-chica" tabindex="-1" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-rojo text-white">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input required v-model="movimiento.detalle" type="text"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input required @keypress="onlyNumber" v-model="movimiento.monto"
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input v-model="movimiento.documento" type="text" class="form-control"
